...
2-Bit Quantization for Vision-Language Models](https://arxiv.org/pdf/2501.15021) by Su, Zunhai, et al., arXiv 2025
...
- [ZipCache: Accurate and Efficient KV Cache Quantization with Salient Token Identification](https://proceedings.neurips.cc/paper_files/paper/2024/file/7e57131fdeb815764434b65162c88895-Paper-Conference.pdf) by He, Yefei, et al., NeurIPS 2025
- [Eigen Attention: Attention in Low-Rank Space for KV Cache Compression](https://arxiv.org/abs/2408.05646)
- [PAROAttention: Pattern-Aware ReOrdering for Efficient Sparse and Quantized Attention in Visual Generation Models](https://arxiv.org/pdf/2506.16054) by Zhao, Tianchen, et al., arXiv 2025
